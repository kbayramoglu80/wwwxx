(function ($) {
  ...
  var headerElement = document.querySelector('.custom-header');
  var lastScrollY = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0;
  var hideAfter = 40;

  function closeMobileHeaderInteractions() {
    var searchWrapper = document.getElementById('mobileSearchWrapper');
    var searchBtn = document.getElementById('mobileSearchBtn');

    if (searchWrapper && window.getComputedStyle(searchWrapper).display !== 'none') {
